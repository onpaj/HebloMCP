...
def test_detect_stdio_mode_explicit():
    ...
    config = HebloMCPConfig(tenant_id="test", client_id="test", transport="stdio")
    assert detect_transport_mode(config) == "stdio"


def test_detect_sse_mode_explicit():
    """Test detection of explicit sse mode."""
    config = HebloMCPConfig(tenant_id="test", client_id="test", transport="sse")
...
def test_detect_auto_mode_defaults_to_stdio():
    ...
    config = HebloMCPConfig(tenant_id="test", client_id="test", transport="auto")
